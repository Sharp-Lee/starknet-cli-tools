...
export async function generateStarkAccounts(mnemonic, startIndex, endIndex, provider) {
...
export async function getStarkERC20TokenBalance(address, tokenAddress, provider) {
...
export async function transferStarkERC20Token(account, tokenAddress, to, amount) {
...
export async function generateEthAccounts(mnemonic, startIndex, endIndex, provider) {
    // 使用助记词生成钱包
